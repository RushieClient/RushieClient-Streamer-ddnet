...
image_ri_hammer = Image("rihammer", "rclient/rihammer.png")
image_ri_hook = Image("rihook", "rclient/rihook.png")
image_ri_icon = Image("riicon", "rclient/rclient_icon.png")
image_ri_icon_red = Image("riicon_red", "rclient/rclient_icon_red.png")
image_ri_icon_white = Image("riicon_white", "rclient/rclient_icon_white.png")
image_rclient_big_logo = Image("rclient_big_logo", "rclient/rclient_big_logo.png")
image_ri_actions = Image("riactions", "rclient/riactions.png")
...
container.images.Add(image_ri_hammer)
container.images.Add(image_ri_hook)
container.images.Add(image_ri_icon)
container.images.Add(image_ri_icon_red)
container.images.Add(image_ri_icon_white)
container.images.Add(image_rclient_big_logo)
container.images.Add(image_ri_actions)
...
set_ri_hammer = SpriteSet("rihammer", image_ri_hammer, 1, 1)
set_ri_hook = SpriteSet("rihook", image_ri_hook, 1, 1)
set_ri_icon = SpriteSet("riicon", image_ri_icon, 1, 1)
set_ri_icon_red = SpriteSet("riicon_red", image_ri_icon_red, 1, 1)
set_ri_icon_white = SpriteSet("riicon_white", image_ri_icon_white, 1, 1)
set_ri_actions = SpriteSet("riactions", image_ri_actions, 2, 1)
...
container.spritesets.Add(set_ri_hammer)
container.spritesets.Add(set_ri_hook)
container.spritesets.Add(set_ri_icon)
container.spritesets.Add(set_ri_icon_red)
container.spritesets.Add(set_ri_icon_white)
container.spritesets.Add(set_ri_actions)
...
container.sprites.Add(Sprite("ri_hook", set_ri_hook, 0, 0, 1, 1))
container.sprites.Add(Sprite("ri_hammer", set_ri_hammer, 0, 0, 1, 1))
container.sprites.Add(Sprite("ri_icon", set_ri_icon, 0, 0, 1, 1))
container.sprites.Add(Sprite("ri_icon_red", set_ri_icon_red, 0, 0, 1, 1))
container.sprites.Add(Sprite("ri_icon_white", set_ri_icon_white, 0, 0, 1, 1))
container.sprites.Add(Sprite("hud_dummy_resetonswitch", set_ri_actions, 0, 0, 1, 1))
container.sprites.Add(Sprite("hud_dummy_control", set_ri_actions, 1, 0, 1, 1))
