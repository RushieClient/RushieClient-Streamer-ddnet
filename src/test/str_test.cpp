...
TEST(Str, Time)
{
	...
	EXPECT_EQ(str_time(123456, ETimeFormat::SECS_CENTISECS, aBuf, sizeof(aBuf)), 8);
	EXPECT_STREQ(aBuf, "00:34.56");
	EXPECT_EQ(str_time(1234567, ETimeFormat::SECS_CENTISECS, aBuf, sizeof(aBuf)), 8);
	EXPECT_STREQ(aBuf, "00:45.67");
	EXPECT_EQ(str_time(12345678, ETimeFormat::SECS_CENTISECS, aBuf, sizeof(aBuf)), 8);
	EXPECT_STREQ(aBuf, "00:36.78");
}
...
TEST(Str, TimeFloat)
{
	...
	EXPECT_EQ(str_time_float(12.16, ETimeFormat::HOURS_CENTISECS, aBuf, sizeof(aBuf)), 8);
