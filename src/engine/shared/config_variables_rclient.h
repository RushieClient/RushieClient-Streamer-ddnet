...
MACRO_CONFIG_INT(RiShowMusicIslandDynamicWidth, ri_show_music_island_dynamic_width, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Dynamically expand music island width when full timer is disabled")
...
MACRO_CONFIG_INT(RiShowMusicIslandFullDynamicWidth, ri_show_music_island_full_dynamic_width, 0, 0, 1, CFGFLAG_CLIENT | CFGFLAG_SAVE, "Dynamically expand music island width when full timer is enabled")
